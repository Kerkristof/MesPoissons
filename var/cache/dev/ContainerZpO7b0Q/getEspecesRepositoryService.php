...
// Returns the private 'App\Repository\EspecesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EspecesRepository.php';

return $this->privates['App\\Repository\\EspecesRepository'] = new \App\Repository\EspecesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
