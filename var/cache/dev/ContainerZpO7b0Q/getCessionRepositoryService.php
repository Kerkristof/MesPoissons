...
// Returns the private 'App\Repository\CessionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CessionRepository.php';

return $this->privates['App\\Repository\\CessionRepository'] = new \App\Repository\CessionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
