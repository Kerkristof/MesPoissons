...
// Returns the private 'App\Repository\SortieCommentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SortieCommentRepository.php';

return $this->privates['App\\Repository\\SortieCommentRepository'] = new \App\Repository\SortieCommentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
