...
// Returns the private 'App\Repository\LoveRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/LoveRepository.php';

return $this->privates['App\\Repository\\LoveRepository'] = new \App\Repository\LoveRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
