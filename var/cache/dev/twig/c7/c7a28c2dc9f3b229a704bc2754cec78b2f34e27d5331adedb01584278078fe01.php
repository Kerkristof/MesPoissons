...
class __TwigTemplate_4f5ba8cb535dbeeed6373c68144dc9cdb1145f8158c11d185f485745afa08820 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 5
            echo "    <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 5)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "nom", [], "any", false, false, false, 5), "html", null, true);
            echo "</a>
    <hr>
";
        }
...
{% for category in categories %}
    <a href=\"{{ path('category_edit',{'id' : category.id})}}\">{{ category.nom }}</a>
    <hr>
{% endfor %}
{% endblock %}
", "categorie/index.html.twig", "/home/christophe/Projects/Symfony/MesPoissons/templates/categorie/index.html.twig");
    }
}
