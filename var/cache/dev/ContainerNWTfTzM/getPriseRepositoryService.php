...
// Returns the private 'App\Repository\PriseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PriseRepository.php';

return $this->privates['App\\Repository\\PriseRepository'] = new \App\Repository\PriseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
